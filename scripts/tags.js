export const TAGS = {
    ...
    icon: `
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            viewBox="0 0 128 128" fill="currentColor" class="icon">
          <path d="M121.8 93.1c-6.7 3.5-41.4 17.7-48.8 21.6-7.4 3.8-11.5 3.8-17.3 1.1C49.9 113 13.1 98.1 6.4 94.7c-3.3-1.6-3.4-3.1-.1-4.6l67.1-26.5c7.4-2.9 9.7-2.9 16.1-.4L121 80c3.3 1.3 3.4 2.7-.2 4.5v8.6z"/>
          <path d="M121.8 75.9c-6.7 3.5-41.4 17.7-48.8 21.6-7.4 3.8-11.5 3.8-17.3 1.1C49.9 95.7 13.1 80.9 6.4 77.4c-3.3-1.6-3.4-3.1-.1-4.6l67.1-26.5c7.4-2.9 9.7-2.9 16.1-.4L121 62.8c3.3 1.3 3.4 2.7-.2 4.5v8.6z"/>
          <path d="M121.8 58.4c-6.7 3.5-41.4 17.7-48.8 21.5-7.4 3.8-11.5 3.8-17.3 1.1C49.9 78.2 13.1 63.3 6.4 59.9c-3.3-1.7-3.4-3.2-.1-4.7l67.1-26.5c7.4-2.9 9.7-2.9 16.1-.3l31.5 11.4c3.3 1.3 3.4 2.8-.2 4.6z"/>
          <path d="M75.2 42.7L54.8 34l20.8-8 20.8 8-21.2 8.7z"/>
        </svg>
    `,
